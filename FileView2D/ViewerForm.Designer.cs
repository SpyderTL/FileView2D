namespace FileView2D
{
	partial class ViewerForm
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			this.splitContainer1.Panel1.Controls.Add(this.LinearPictureBox);
			// 
			// splitContainer1.Panel2
			// 
			this.splitContainer1.Panel2.Controls.Add(this.DistancePictureBox);
			...
			// LinearPictureBox
			// 
			this.LinearPictureBox.Dock = System.Windows.Forms.DockStyle.Fill;
			this.LinearPictureBox.Location = new System.Drawing.Point(0, 0);
			this.LinearPictureBox.Name = "LinearPictureBox";
			this.LinearPictureBox.Size = new System.Drawing.Size(336, 705);
			this.LinearPictureBox.SizeMode = System.Windows.Forms.PictureBoxSizeMode.StretchImage;
			this.LinearPictureBox.TabIndex = 0;
			this.LinearPictureBox.TabStop = false;
			this.LinearPictureBox.MouseMove += new System.Windows.Forms.MouseEventHandler(this.LinearPictureBox_MouseMove);
			this.LinearPictureBox.MouseUp += new System.Windows.Forms.MouseEventHandler(this.LinearPictureBox_MouseUp);
			// 
			// DistancePictureBox
			// 
			...
			this.DistancePictureBox.Size = new System.Drawing.Size(668, 705);
			this.DistancePictureBox.SizeMode = System.Windows.Forms.PictureBoxSizeMode.StretchImage;
			this.DistancePictureBox.TabIndex = 1;
			...
			this.Text = "File View 2D";
			this.DragDrop += new System.Windows.Forms.DragEventHandler(this.ViewerForm_DragDrop);
			this.DragOver += new System.Windows.Forms.DragEventHandler(this.ViewerForm_DragOver);
